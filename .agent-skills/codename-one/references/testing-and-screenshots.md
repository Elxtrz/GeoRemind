...
```
~/.codenameone/<package.GeoReminder>/   (Mac/Linux)
%APPDATA%\.codenameone\<package.GeoReminder>\   (Windows)
```
...
rm ~/.codenameone/com.tijil.reminder.GeoReminder/settings-screen.png
